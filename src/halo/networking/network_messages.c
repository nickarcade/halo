...
bool FUN_0011a230(data_encoding_state_t *state, const char *source, short max_length)
{
  short string_length;
  int dest;
...
void FUN_0011a2d0(data_encoding_state_t *state, void *buffer, int buffer_size)
{
  if (buffer == NULL) {
...
int FUN_0011a340(data_encoding_state_t *state, short count, void *bs_definition)
{
  short total_size;
  int result;
...
__declspec(noinline) int FUN_0011a430(data_encoding_state_t *state, short count, int element_size)
{
  int byte_count;
  int result;
...
__declspec(noinline) unsigned char FUN_0011a560(data_encoding_state_t *state)
{
  int new_offset;
  unsigned char *ptr;
 ...
 * Source: data_encoding.c. */
short FUN_0011a5d0(data_encoding_state_t *state)
{
  short *ptr;
 ...
 * Source: data_encoding.c. */
int FUN_0011a650(data_encoding_state_t *state)
{
  int *ptr;
...
int64_t FUN_0011a6d0(data_encoding_state_t *state)
{
  int64_t *ptr;
...
__declspec(noinline) unsigned int FUN_0011a700(data_encoding_state_t *state, int maximum_value)
{
  if (maximum_value <= 0) {
  ...
  if (maximum_value <= 0xff) {
    return (unsigned char)FUN_0011a560(state);
  }
  if (maximum_value <= 0xffff) {
    return (short)FUN_0011a5d0(state);
  }
  return FUN_0011a650(state);
}

/* decode_element_array — read count + structures from buffer (0x11a770).
 * Source: data_encoding.c line 0x15c. */
void *FUN_0011a770(data_encoding_state_t *state, int element_size_type,
                   ...
                   void *bs_definition)
{
  ...
  case 1:
    count = (int)(unsigned char)FUN_0011a560(state);
    break;
  case -2:
    count = (int)(short)FUN_0011a5d0(state);
    break;
  case -4:
    count = FUN_0011a650(state);
    break;
  case -8:
    count = (int)FUN_0011a6d0(state);
    break;
  default:
  ...
  if (state->overflow == '\0' && count >= 0 && count <= maximum_element_count) {
    *element_count_ref = (unsigned int)count;
    return (void *)FUN_0011a340(state, (short)count, bs_definition);
  }
  return NULL;
}
 ...
 * Source: data_encoding.c. */
__declspec(noinline) char *FUN_0011a8e0(data_encoding_state_t *state, unsigned short max_length)
{
  int offset;
  short scan_count;
  char *base;
...
void FUN_0011b2a0(int definition, data_encoding_state_t *decode_state, unsigned short version,
...
int FUN_0011ba50(short *table_, void *key, unsigned short *slot_index_out)
{
  hashtable_t *table;
  short hash_val;
  short slot;
  ...
  if (table->hash_proc != NULL) {
    ...
    hash_val =
      (short)FUN_0011ba00((unsigned char *)key, (unsigned int)table->key_size);
  }
...
int FUN_0011bb70(short *table_, void *key)
{
  hashtable_t *table;
  char found;
  int element_ptr;
...
void FUN_0011bc20(short *table, void *key)
{
  ...
  found = (char)FUN_0011ba50(table, key, (unsigned short *)&removed_slot);
  if (found != '\0') {
...
int FUN_0011c0f0(short *table, void *key)
{
  ...
  if ((ht->capacity_bits == -1) ||
    ...
    grew = (char)FUN_0011beb0(table, (short)((ht->capacity_bits == -1) + 1));
    if (grew == '\0') {
      return 0;
    }
  }
