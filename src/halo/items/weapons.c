...
boolean weapon_trigger_can_fire_again(int weapon_handle, int16_t trigger_index)
{
  ...
  weapon = (char *)object_get_and_verify_type(weapon_handle, 4);
  trigger_data = (char *)weapon_trigger_get(weapon, trigger_index);
  tag = (char *)tag_get(0x77656170, *(uint32_t *)weapon);
  trigger_def = (char *)tag_block_get_element((char *)tag + 0x4fc, (int)trigger_index, 0x114);
        ...
        case 11:
          {
            ...
            if (trig_idx < *(int *)(tag + 0x4fc)) {
              ...
              weapon_trigger_get(weapon, (int16_t)trig_idx);
              value = weapon_trigger_get_charged_fraction(weapon_handle, (int16_t)trig_idx);
            }
          }
          break;
        case 12:
          {
            ...
            for (i = 0; i < trig_count; i++) {
              ...
              char *trig_data = (char *)weapon_trigger_get(weapon, (int16_t)i);
              if (*(float *)(trig_def + 0x48) <= 0.0f) {
                float f = weapon_trigger_get_charged_fraction(weapon_handle, (int16_t)i) * *(float *)(trig_def + 0x54);
                if (value < f) {
                  value = f;
                }
              }
...
void weapon_trigger_recover(int trigger_index, int weapon_handle)
{
  ...
  weapon = (char *)object_get_and_verify_type(weapon_handle, 4);
  trigger_data = (char *)weapon_trigger_get(weapon, (int16_t)trigger_index);
  tag = (char *)tag_get(0x77656170, *(uint32_t *)weapon);
...
void weapon_trigger_begin_firing(int weapon_handle, int16_t trigger_index, char param_3)
{
  ...
  can_fire = true;
  if (*(int16_t *)(trig_def + 0x20) != -1) {
    tag_block_get_element((char *)tag + 0x4f0, (int)*(int16_t *)(trig_def + 0x20), 0x70);
    if (*(int16_t *)weapon_magazine_get(weapon, *(int16_t *)(trig_def + 0x20)) != 0) {
      can_fire = false;
    }
  }
  ...
  if (param_3 != 0) {
    weapon_trigger_fire(weapon_handle, (int)trigger_index);
    return;
  }
  ...
  if (*(float *)(trig_def + 0x48) > 0.0f) {
    ...
    if (*(int *)(tag + 0x4fc) > 1) {
      *(int *)(trig_data + 0x20) = weapon_effect_new(*(int *)(trig_def + 0x68), 0.0f, 0.0f, weapon_handle);
    } else {
